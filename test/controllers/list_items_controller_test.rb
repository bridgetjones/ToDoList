...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post list_items_url, params: { list_item: { description: @list_item.description, is_complete: @list_item.is_complete, name: @list_item.name } }
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { description: @list_item.description, is_complete: @list_item.is_complete, name: @list_item.name } }
